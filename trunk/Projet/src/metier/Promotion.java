...
public class Promotion {
	...
	public void ajouterBDD() {
		...
		String requete = "INSERT INTO PROMO (IDPROMO, NOMPROMO, DATEDEBUT,"
				...
				+ this.idPromotion + "'," + "'" + this.nomPromotion + "'," + s
				+ "," + s2 + "," + this.pourcentagePromo + "," + pf + ")";
	...
	public static void modifierPromoBDD(String idPromo, String nomPromotion,
		...
		String requete = " UPDATE PROMO" + " SET NOMPROMO = '" + nomPromotion
				+ "'," + "    DATEDEBUT = " + dateD + "," + "    DATEFIN= "
				+ dateF + ", " + "    POURCENTAGEPROMO= " + pourcentagePromo
				+ ", " + "	 PROMOFIDELITE=" + pf + "" + " WHERE IDPROMO='"
				+ idPromo + "'";
	...
	/**
	 * Vérifie si la date saisie est cohérente (à travers l'année, le mois et le
	 * jour entrés en paramètres) Pour cela, la fonction procède étape par étape
	 * <p>
	 * <ul>
	 ...
	 * </ul>
	 * </ul> Si au moins l'un de ces tests est faux alors la fonction renvoie la
	 * valeur "faux". Si tous les tests sont réussis, la valeur renvoyée par la
	 * fonction est "vrai".
	 * </p>
	 * 
	 * @param annee
