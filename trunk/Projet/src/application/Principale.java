 ...
 * @throws Exception **/
	...
	public static void main(String[] args) throws Exception {
		...
		//activDesactivCompte();
		/*
		  //Création de la table CLIENTS SGBD.creerTable("CLIENTS");
		...
		/*
		  ...
		  Article art7 = new
		  Article("ART007","Selle","Équitation",250,50,5,"3"); Article art8 =
		  new Article("ART008","Chaussures NIKE","Running",250,100,60,"2");
		  Article art9 = new
		  Article("ART009","Kimono","Sport de combat",750,35,30,"2"); Article
		  art10 = new
		  Article("ART010","Raquette de tennis débutant","Sport de raquette"
		  ,170,20,50,"3");
		 */
		...
		// MAJ de la table COMMANDES
		// Créationdes tables COM1 et COM2
