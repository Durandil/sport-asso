...
public class ModeleMessagerie extends AbstractTableModel {
	 ...
	 */
	private final String[] entetes = { "Numéro Message", "Expéditeur", "Sujet",
			"Contenu", "Date" };
	 ...
	 *            <p>
	 *            Booléen indiquant si la messagerie est celle du gérant ou
	 *            celle d'un client :
	 *            <ul>
	...
	/**
	 * Retourne le libellé de la colonne situé à l'index spécifié en paramètre
	 * 
	 * @param columnIndex
	 *            numéro de la colonne dont on veut connaître le nom
	 * 
	 * @return Le libellé de la colonne situé à l'index spécifié en paramètre
	 *         (int)
	 */
	...
	/**
	 * Méthode qui supprime tous les messages de la table
	 */
