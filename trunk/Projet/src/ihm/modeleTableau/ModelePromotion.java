 ...
 * promotions au client pour pouvoir éventuellement dans ses commandes.
 * </ul>
 * </p>
 */
public class ModelePromotion extends AbstractTableModel {
	...
	/**
	 * <p>
	 * Construit un tableau répertoriant l'ensemble des promotions présentes
	 * dans la base de données avec les informations suivantes pour chaque
	 * promotion :
	 * <ul>
	 * <li>son identifiant unique</li>
	 * <li>sa description</li>
	...
	public ModelePromotion(boolean pourGerant) {
		...
		if (pourGerant) {
			...
			listeDatesFin = SGBD.selectListeDatesOrdonne("PROMO", "DATEFIN",
					"DD/MM/YYYY", "IDPROMO");
			listeIdentifiants = SGBD.selectListeStringOrdonne("PROMO",
					"IDPROMO", "IDPROMO");
			...
			if (fideliteUtilisateur.get(0).equals("Oui")) {
				...
				listeIdentifiants = SGBD.selectListeStringOrdonneCondition(
						"PROMO", "IDPROMO", "IDPROMO", "DATEFIN > SYSDATE");
				listeDatesDebut = SGBD.selectListeStringOrdonneCondition(
						"PROMO", "DATEDEBUT", "IDPROMO", "DATEFIN > SYSDATE");
				listeDatesFin = SGBD.selectListeStringOrdonneCondition("PROMO",
