...
/**
 * Cette classe MenuGerant permet d'initialiser la page d'accueil du gérant dans
 * laquelle il a accès aux fonctionnalités définies dans le cas d'utilisation du
 * gérant. Cette fenêtre apparaîtra avec une barre de menus dans lequel le
 * gérant pourra accéder aux différents sous-menus.
 * 
 * @author Utilisateur {@link MenuGerant#MenuGerant()}
 */
public class MenuGerant extends JFrame {
	 ...
	 * Les JMenu vont accueillir les JMenuItem qui les sous-menus sur lesquels
	 * le gérant pourra cliquer et en même temps accéder aux différentes
	 * fontionnalités spécifiées dans son cas d'utilisation
	 * 
	 */
	...
	private JMenuItem itemCommandes = new JMenuItem(
	...
	/**
	 * <p>
	 * Constructeur de la classe MenuGérant dans lequel nous spécifions toutes
	 * les caractéristiques de notre menu.
	 * <ul>
	 * <li>Dans un premier temps, on insère une image de fond pour la fenetre.</li>
	 * <li>Puis, pour chaque sous-menu, nous allons lui spécifier son action (ie
	 * la nouvelle fenêtre à afficher).</li>
	...
	public MenuGerant() {
		...
		itemGestionCompte.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				FenetreRechercheClient recherche = new FenetreRechercheClient(
						null, "Recherche de clients", true);
		...
		itemFermer.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int res = JOptionPane.showConfirmDialog(null,
						"Confirmez-vous la fermeture du compte gérant ?",
		...
		itemArticles.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Affichage de la fenetre avec la dernière version du catalogue
				// client
