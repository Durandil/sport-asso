...
public class FenetreSuppressionPanier extends JDialog {
	 ...
	 * @param numeroArticle
	 *            Identifiant de l'article dont on veut retirer une certaine
	 *            quantité
	 * @param quantitePanier
	 *            Entier désignant la quantité actuellement commandée de
	 ...
	 * 
	 */
	public FenetreSuppressionPanier(JFrame parent, String title, boolean modal,
			String numeroArticle, int quantitePanier) {
	 ...
	 * quantité à retirer du panier sans dépasser la quantité déjà commandée.</li>
	...
	private void initComponent(int quantiteEntree, String idArticle) {
		...
		panneauQuantite.setBorder(BorderFactory
				.createTitledBorder("Supprimer du panier"));
		...
		JButton boutonValiderSuppression = new JButton(
				"Valider Modification Panier");
