...
/**
 * Cette classe permettra d'afficher les détails d'une commande particulière
 * pour le gérant
 * 
 * 
 * @see FicheClient
...
public class FenetreStatistiqueCommande extends JDialog {
	 ...
	 * <p>
	 * Cette fenêtre est similaire à une facture dont on affiche les détails.
	 * </p>
	 * 
	 * @param parent
	 ...
	 */
	public FenetreStatistiqueCommande(JFrame parent, String title,
			boolean modal, String numCommande) {
	...
	private void initComponent(String idCommande) {
		...
		String date = SGBD.selectStringConditionString("COMMANDE",
				"DATECOMMANDE", "IDCOMMANDE", idCommande);
		JLabel dateCommandeLabel = new JLabel("Date : " + date);
		JLabel referenceCommandeLabel = new JLabel("Référence commande : "
				+ idCommande);
		JLabel montantCommandeLabel = new JLabel("Montant de la commande : "
				+ SGBD.selectStringConditionString("COMMANDE",
						"MONTANTCOMMANDE", "IDCOMMANDE", idCommande) + " €");
		...
		// commandées de chacun des articles avec ModeleTableauStatCommande
