...
/**
 * <b> FenetreAffichageRecherche affiche les résultats d'une recherche de clients
 * par le gérant </b>
 * <p> Les clients affichés correspondent à la recherche d'un gérant selon plusieurs 
 * critères :<ul>
...
public class FenetreAffichageRecherche extends JDialog{
	...
	/**
	 * <b> Constructeur de la fenêtre d'affichage des résultats d'une recherche de clients
	 * par le gérant. </b>
	 * 
	 * <p> Elle sera construite avec la méthode initComponent. </p>
	 * 
	 * @param parent
	...
	/**
	 * <p> Initialisation des composants de la fenêtre avec :<ul>
	 * <li> un JPanel contenant un tableau avec la liste des clients correspondants à la 
	 * recherche.</li>
	 * <li> un JPanel contenant deux boutons : l'un permettant d'accéfer à la fiche d'un client 
	 * après l'avoir sélectionné et l'autre permettant de revenir à la page précédente. </li>
	 * 
     * @param idClient
     * 			String saisi dans le champ de recherche identifiant client
     * @param nom
