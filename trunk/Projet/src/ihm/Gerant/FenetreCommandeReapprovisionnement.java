...
/**
 * <b> Cette classe permet la sélection de la quantité pour réapprovisionner un
 * article avec une faible quantité en stock. <b>
 * <p>
 * Elle apparaît généralement après avoir sélectionné correctement l'article que
 * l'on souhaite réapprovisionner dans
 * {@link FenetreCommandeReapprovisionnement}.
 * </p>
 * 
 * 
...
public class FenetreCommandeReapprovisionnement extends JDialog {
	 ...
	 */
	public FenetreCommandeReapprovisionnement(JFrame parent, String title,
	 ...
	 * <ul>
	 * <li>un JPanel contenant un JComboBox dans lequel le gérant sélectionnera
	 * la quantité à réapprovisionner de l'article.</li>
	 * <li>un JPanel contenant deux boutons : l'un permettant de valider le
	 * réapprovisionnement et l'autre pour l'annuler.</li>
	 * </ul>
	 * </p>
	 * 
	 * @param idArticle
