...
public class FenetreFideliteClient extends JDialog {
	 ...
	 * fenêtre avec des composants permettant de connaître les différentes
	...
	private void initComponent() {
		...
		if (estFidele.equals("Non")) {
			// Si le client n'est pas adhérent
			nbPoints = 0;
		...
		boutonAffichageBons.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// présents sur sa carte de fidelite
		...
		// Si le client est adhérent, nous ne lui affichons que le bouton retour
