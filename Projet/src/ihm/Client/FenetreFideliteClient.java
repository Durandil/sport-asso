...
/**
 * <p>Cette classe FenetreFideliteClient permet d'afficher pour tous les clients les détails 
 * de leur programme fidélité avec le magasin sport'asso :<ul>
...
public class FenetreFideliteClient extends JDialog {
	...
	/**
	 * Constructeur de la classe FenetreFideliteClient qui permet de créer une fenetre
	 * avec des composants permettant de connaître les différentes informations concernant
	 * leur adhésion au magasin grâce à un JComboBox, un JTextField pour afficher les points
	 * et un bouton permettant d'afficher le montant du bon d'achat du client
	 * 
	 * @param parent 
	 ...
	 * <li> le JPanel contenant le JComboBox sur l'état du compte du client qui peut être modifié
	 * si le client ne possède pas encore de compte adhérent. </li>
	 * <li> le JPanel contenant le JTextField affichant le nombre de points sur le compte fidélité.</li>
	 * <li> le JPanel contenant les boutons de confirmation ou d'annulation de création d'une 
	 * carte de fidélité pour le client. </li>
	 * </ul>
	 * </p>
	 */
	private void initComponent(){
		...
		boutonAffichageBons.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				//Gestion des bons achat du client selon le nombre de points présents
        ...
        // Définition du bouton Confirmer qui permet de confirmer la création d'une nouvelle carte de fidélité
