...
/**
 * La classe FenetrePromotions permet d'afficher dans un tableau l'ensemble des promotions
...
public class FenetrePromotions extends JFrame {
	...
	/**
	 * Constructeur de la classe FenetrePromotions qui affiche un tableau de l'ensemble des 
	 * promotions de la base de données grâce à {@link ModelePromotion} dans lequel on peut cliquer
	 * pour afficher les détails d'une promotion
	 * 
	 * @see ModelePromotion
	 */
    ...
    /**
     * <p>Initialisation des composants de la fenetre :<ul>
    ...
    private void initComponent(){
    	...
    	// Création d'un JPanel panneauTitle qui accueillera un texte introductif en haut de 
    	// la fenêtre
