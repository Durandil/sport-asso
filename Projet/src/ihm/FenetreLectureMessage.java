...
/**
 * Cette classe FenetreLectureMessage permet à tout utilisateur de l'application
 * ayant un message dans sa boite de réception interne de pouvoir lire le
 * message Elle est construite à partir de
 * {@link FenetreLectureMessage#FenetreLectureMessage(JFrame, String, boolean, String, String, String, String, String, boolean)}
 * 
 */
public class FenetreLectureMessage extends JDialog {
	...
	/**
	 * Constructeur de la fenêtre de lecture de message qui prend en paramètre
	 * tous les attributs d'un message. Cette fenêtre est construite à partir de
	 * {@link FenetreLectureMessage#initComponent(String, String, String, String, String, boolean)}
	 * 
	 * @param parent
	...
	public FenetreLectureMessage(JFrame parent, String title, boolean modal,
		...
		this.initComponent(exp, sujetM, contenuM, dateM, ident,
				lectureMessageGerant);
	}

	/**
	 * <p>
	 * Initialisation des composants contenus dans la fenêtre:
	 * <ul>
	 * <li>un JPanel en haut de la fenêtre accueillant la date d'envoi,
	 * l'expéditeur et le sujet du message.</li>
	 * <li>un JPanel au centre de la fenêtre accueillant le contenu du message.</li>
	 * <li>un JPanel en bas de fenêtre contenant trois boutons : retour à la
	 * page précédente, répondre au message ou supprimer.</li>
	 * </ul>
	 * </p>
	 * 
	 * @param expediteur
	...
	private void initComponent(String expediteur, String sujet, String contenu,
		...
		// Création d'un JPanel qui accueillera //
		// les informations : Date, Expéditeur  //
		// ------et sujet du message -----------//
		// -------------------------------------//
		...
		boutonRepondre.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				dispose();
				FenetreReponseMessage fenReponse = new FenetreReponseMessage(
						reponseGerant, sujetMessage.getText());
