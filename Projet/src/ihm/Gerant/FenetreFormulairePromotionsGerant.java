...
public class FenetreFormulairePromotionsGerant extends JDialog {
	...
	private void initComponent() {
		...
		// contenant les JTextField et les JComboBox pour sélectionner les dates
		// de début et de fin
		...
		// client est destiné la promotion
		...
		// lequel est destiné la promotion
		...
		// Définition des JComboBox pour permettre de sélectionner le jour,le
		// mois et l'année de début et de fin d'une promotion
		...
		// champs saisis et selectionnés soient corrects
		...
		boutonConfirmation.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					// Si aucune Exception n'est levée, la création de la
					// promotion
					...
					// Fermeture de la fenêtre et retour vers la fenêtre
					// d'accueil
	 ...
	 * 
	 * <p>
	 * Initialisation des composants de la fenêtre de modification d'une
	 * promotion :
	 * <ul>
	 * <li>un JPanel qui accueillir les 6 sous-JPanels contenant les JTextField
	...
	private void initComponent(String idPromo) throws Exception {
		...
		// afin de pré-remplir les JTextField avec la valeur enregistrée dans la
		// base de données et de compléter la valeur par défaut des JComboBox
		...
		// type de client est destiné la promotion
		...
		// sur lequel est destiné la promotion

		articleBox = new JComboBox();
		// Récupération de la liste de tous les articles présents dans le
		// magasin
		ArrayList<String> listeArticles = new ArrayList<String>();
		listeArticles = SGBD.selectListeStringOrdonneCondition("ARTICLE",
				"IDARTICLE", "IDARTICLE", "ETATARTICLE != 'Supprimé'");
		...
		articleBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Récupération de l'identifiant de l'article sélectionné dans
				// le menu déroulant
				...
				// Affichage d'une fenêtre pour indiquer au gérant la
		...
		// remplis panDescriptionPromotion.add(descriptionLabel);
		panPopulation.add(populationLabel);
		panArticle.add(articleLabel);
		panPourcentPromo.add(pourcentLabel);
		...
		boutonConfirmation.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Phase de vérification des champs remplis et sélectionnés par
				// le gérant
				String position = null;
				...
				try {
					...
					// Puis fermeture de la fenêtre et affichage de la fenêtre
					// d'accueil
					// de gestion des promotions exceptionnelles
					dispose();
					FenetrePromotionsGerant fen = new FenetrePromotionsGerant(
