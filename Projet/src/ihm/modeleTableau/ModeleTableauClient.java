...
/**
 * <p>
 * La classe ModeleTableauClient hérite de la classe AbstractTableModel Sa
 * spécificité est de pouvoir afficher uniquement les clients correspondants à
 * la recherche d'un gérant selon plusieurs critères :
 * <ul>
 ...
 * </ul>
 * 
 * Les tableaux générés à partir de cette classe sont utilisés dans la fenêtre
 * {@link FenetreAffichageRecherche}
 * 
 */
public class ModeleTableauClient extends AbstractTableModel {
	 ...
	 */
	private final String[] entetes = { "Identifiant", "Nom", "Prénom",
			"Dénomination" };

	/**
	 * Construit des tableaux correspondants aux résultats de la recherche de
	 * clients du gérant
	 * 
	 ...
	 */
	public ModeleTableauClient(String idClient, String nom, String denom,
			String ville) {
		super();
		// Quatre listes sont créées pour récupérer les informations de la table
		// ARTICLES
		ArrayList<ArrayList<String>> listeClients = SGBD
				.recupererInformationRechercheClient(idClient, nom, denom,
						ville);
	 ...
	 *         correspondants à la recherche du gérant
	 */
